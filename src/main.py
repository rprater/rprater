...
def update_footer():
    timestamp = datetime.datetime.now(pytz.timezone("Canada/Eastern")).strftime("%c")
...
rss_title = "### Stories by Robert Prater on Medium" # Anchor for where to append posts
readme = Path('../README.md').read_text()
updated_readme = update_readme_medium_posts("https://medium.com/feed/@robcprater", readme, rss_title)
